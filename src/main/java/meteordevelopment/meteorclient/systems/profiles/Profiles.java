...
public class Profiles extends System<Profiles> implements Iterable<Profile> {
    public static final File FOLDER = new File(MeteorClient.FOLDER, "配置文件");
    ...
    public NbtCompound toTag() {
        ...
        tag.put("配置文件", NbtUtils.listToTag(profiles));
        return tag;
    }

    @Override
    public Profiles fromTag(NbtCompound tag) {
        profiles = NbtUtils.listFromTag(tag.getListOrEmpty("配置文件"), Profile::new);
        return this;
    }
}
