...
public class AboutTranslateAuthor extends Module {
    ...
    public void onActivate() {
        ...
        ClickEvent click = new RunnableClickEvent(() -> new ClickEvent.OpenUrl(uri));
        MutableText clickableText = Text.literal("点击这里跳转到译者的B站页面")
            .setStyle(Style.EMPTY.withClickEvent(click))
            .withColor(5592575);
        ChatUtils.sendMsg(clickableText);
    }
}
