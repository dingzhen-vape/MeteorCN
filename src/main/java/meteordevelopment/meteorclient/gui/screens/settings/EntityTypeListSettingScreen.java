...
public class EntityTypeListSettingScreen extends WindowScreen {
    ...
    public void initWidgets() {
        ...
        animals = theme.section("动物", animals != null && animals.isExpanded(), animalsC);
        ...
        waterAnimals = theme.section("水生动物", waterAnimals != null && waterAnimals.isExpanded(), waterAnimalsC);
        ...
        monsters = theme.section("怪物", monsters != null && monsters.isExpanded(), monstersC);
        ...
        ambient = theme.section("环境", ambient != null && ambient.isExpanded(), ambientC);
        ...
        misc = theme.section("杂项", misc != null && misc.isExpanded(), miscC);
