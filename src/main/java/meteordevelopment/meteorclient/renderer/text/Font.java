...
public class Font {
    ...
    public Font(ByteBuffer buffer, int height) {
        ...
        STBTTPackedchar.Buffer[] cdata = {
            ...
            STBTTPackedchar.create(20976) // infinity symbol
        };
        ...
        packRange.put(STBTTPackRange.create().set(height, 0x4E00, null, 20976, cdata[6], (byte) 2, (byte) 2)); // Chinese simplified (全范围)
